...
Built using **HTML, CSS, and JavaScript**, with real movie data fetched dynamically from the **TMDB API**.
...
- Landing page with marketing hero section
...
- Optional authentication UI (frontend-only)
